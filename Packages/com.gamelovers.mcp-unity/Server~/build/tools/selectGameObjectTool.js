 ...
 */
export function registerSelectGameObjectTool(server, mcpUnity, logger) {
...
async function toolHandler(mcpUnity, params) {
    ...
    if (params.objectPath === undefined && params.objectName === undefined && params.instanceId === undefined) {
        throw new McpUnityError(ErrorType.VALIDATION, "Either 'objectPath', 'objectName' or 'instanceId' must be provided");
    }
